...
#println(join(output, ' '))
#println(size(output))
ABIDE_paitents_features_tri_positive,ABIDE_paitents_features_qua_positive,ABIDE_paitents_features_tri_negative,ABIDE_paitents_features_qua_negative = extract_features(merged_data1, T)
println("=======================AD is ok")
ABIDE_control_features_tri_positive,ABIDE_control_features_qua_positive,ABIDE_control_features_tri_negative,ABIDE_control_features_qua_negative = extract_features(merged_data2, T)
println("=======================")
...
output_file_ad3 = "ABIDE_paitents_features_tri_positive.txt"
writedlm(output_file_ad3, ABIDE_paitents_features_tri_positive, '\t')  # 使用制表符分隔

output_file_ad4 = "ABIDE_paitents_features_qua_positive.txt"
writedlm(output_file_ad4, ABIDE_paitents_features_qua_positive, '\t')  # 使用制表符分隔

output_file_ad5 = "ABIDE_paitents_features_tri_negative.txt"
writedlm(output_file_ad5, ABIDE_paitents_features_tri_negative, '\t')  # 使用制表符分隔

output_file_ad6 = "ABIDE_paitents_features_qua_negative.txt"
writedlm(output_file_ad6, ABIDE_paitents_features_qua_negative, '\t')  # 使用制表符分隔

# 保存 features_CN

output_file_CN3 = "ABIDE_control_features_tri_positive.txt"
writedlm(output_file_CN3, ABIDE_control_features_tri_positive, '\t')  # 使用制表符分隔

output_file_CN4 = "ABIDE_control_features_qua_positive.txt"
writedlm(output_file_CN4, ABIDE_control_features_qua_positive, '\t')  # 使用制表符分隔

output_file_CN5 = "ABIDE_control_features_tri_negative.txt"
writedlm(output_file_CN5, ABIDE_control_features_tri_negative, '\t')  # 使用制表符分隔

output_file_CN6 = "ABIDE_control_features_qua_negative.txt"
writedlm(output_file_CN6, ABIDE_control_features_qua_negative, '\t')  # 使用制表符分隔
