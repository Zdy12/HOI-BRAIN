...
function extract_features(processed_data, T)
    ...
    return features_edge_positive,features_edge_negative,features_tri_positive,features_qua_positive,features_tri_negative,features_qua_negative
end
...
#println(join(output, ' '))
#println(size(output))
AD_features_edge_positive,AD_features_edge_negative,AD_features_tri_positive,AD_features_qua_positive,AD_features_tri_negative,AD_features_qua_negative = extract_features(processed_data_AD, T)
println("=======================AD is ok")
CN_features_edge_positive,CN_features_edge_negative,CN_features_tri_positive,CN_features_qua_positive,CN_features_tri_negative,CN_features_qua_negative = extract_features(processed_data_CN, T)
println("=======================")
MCI_features_edge_positive,MCI_features_edge_negative,MCI_features_tri_positive,MCI_features_qua_positive,MCI_features_tri_negative,MCI_features_qua_negative = extract_features(processed_data_MCI, T)
println("=======================")
...
# 保存 features_AD
output_file_ad1 = "AD_features_edge_positive.txt"
writedlm(output_file_ad1, AD_features_edge_positive, '\t')  # 使用制表符分隔

output_file_ad2 = "AD_features_edge_negative.txt"
writedlm(output_file_ad2, AD_features_edge_negative, '\t')  # 使用制表符分隔

output_file_ad3 = "AD_features_tri_positive.txt"
writedlm(output_file_ad3, AD_features_tri_positive, '\t')  # 使用制表符分隔

output_file_ad4 = "AD_features_tri_negative.txt"
writedlm(output_file_ad4, AD_features_tri_negative, '\t')  # 使用制表符分隔

output_file_ad5 = "AD_features_qua_positive.txt"
writedlm(output_file_ad5, AD_features_qua_positive, '\t')  # 使用制表符分隔

output_file_ad6 = "AD_features_qua_negative.txt"
writedlm(output_file_ad6, AD_features_qua_negative, '\t')  # 使用制表符分隔

# 保存 features_CN
output_file_CN1 = "CN_features_edge_positive.txt"
writedlm(output_file_CN1, CN_features_edge_positive, '\t')  # 使用制表符分隔

output_file_CN2 = "CN_features_edge_negative.txt"
writedlm(output_file_CN2, CN_features_edge_negative, '\t')  # 使用制表符分隔

output_file_CN3 = "CN_features_tri_positive.txt"
writedlm(output_file_CN3, CN_features_tri_positive, '\t')  # 使用制表符分隔

output_file_CN4 = "CN_features_tri_negative.txt"
writedlm(output_file_CN4, CN_features_tri_negative, '\t')  # 使用制表符分隔

output_file_CN5 = "CN_features_qua_positive.txt"
writedlm(output_file_CN5, CN_features_qua_positive, '\t')  # 使用制表符分隔

output_file_CN6 = "CN_features_qua_negative.txt"
writedlm(output_file_CN6, CN_features_qua_negative, '\t')  # 使用制表符分隔


# 保存 features_MCI
output_file_MCI1 = "MCI_features_edge_positive.txt"
writedlm(output_file_MCI1, MCI_features_edge_positive, '\t')  # 使用制表符分隔

output_file_MCI2 = "MCI_features_edge_negative.txt"
writedlm(output_file_MCI2, MCI_features_edge_negative, '\t')  # 使用制表符分隔

output_file_MCI3 = "MCI_features_tri_positive.txt"
writedlm(output_file_MCI3, MCI_features_tri_positive, '\t')  # 使用制表符分隔

output_file_MCI4 = "MCI_features_tri_negative.txt"
writedlm(output_file_MCI4, MCI_features_tri_negative, '\t')  # 使用制表符分隔

output_file_MCI5 = "MCI_features_qua_positive.txt"
writedlm(output_file_MCI5, MCI_features_qua_positive, '\t')  # 使用制表符分隔

output_file_MCI6 = "MCI_features_qua_negative.txt"
writedlm(output_file_MCI6, MCI_features_qua_negative, '\t')  # 使用制表符分隔