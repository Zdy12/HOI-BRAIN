...
#println(join(output, ' '))
#println(size(output))
PPMI_paitents_void_features_qua_positive,PPMI_paitents_cycle_features_tri_positive,PPMI_paitents_void_features_qua_negative,PPMI_paitents_cycle_features_tri_negative = extract_features(merged_data1, T)
PPMI_prodromal_void_features_qua_positive,PPMI_prodromal_cycle_features_tri_positive,PPMI_prodromal_void_features_qua_negative,PPMI_prodromal_cycle_features_tri_negative = extract_features(merged_data2, T)
...
output_file_AD1 = "PPMI_paitents_void_features_qua_positive.txt"
writedlm(output_file_AD1, PPMI_paitents_void_features_qua_positive, '\t')  # 使用制表符分隔

output_file_AD2 = "PPMI_paitents_cycle_features_tri_positive.txt"
writedlm(output_file_AD2, PPMI_paitents_cycle_features_tri_positive, '\t')  # 使用制表符分隔

output_file_AD3 = "PPMI_paitents_void_features_qua_negative.txt"
writedlm(output_file_AD3, PPMI_paitents_void_features_qua_negative, '\t')  # 使用制表符分隔

output_file_AD4 = "PPMI_paitents_cycle_features_tri_negative.txt"
writedlm(output_file_AD4, PPMI_paitents_cycle_features_tri_negative, '\t')  # 使用制表符分隔

output_file_CN1 = "PPMI_prodromal_void_features_qua_positive.txt"
writedlm(output_file_CN1, PPMI_prodromal_void_features_qua_positive, '\t')  # 使用制表符分隔

output_file_CN2 = "PPMI_prodromal_cycle_features_tri_positive.txt"
writedlm(output_file_CN2, PPMI_prodromal_cycle_features_tri_positive, '\t')  # 使用制表符分隔

output_file_CN3 = "PPMI_prodromal_void_features_qua_negative.txt"
writedlm(output_file_CN3, PPMI_prodromal_void_features_qua_negative, '\t')  # 使用制表符分隔

output_file_CN4 = "PPMI_prodromal_cycle_features_tri_negative.txt"
writedlm(output_file_CN4, PPMI_prodromal_cycle_features_tri_negative, '\t')  # 使用制表符分隔
