...
# 保存 features_AD
output_file_ad1 = "paitient_features_void_positive.txt"
writedlm(output_file_ad1, AD_features_positive, '\t')  # 使用制表符分隔

output_file_ad2 = "paitient_features_void_negative.txt"
...
# 保存 features_MCI
output_file_MCI1 = "control_features_void_positive.txt"
writedlm(output_file_MCI1, MCI_features_positive, '\t')  # 使用制表符分隔

output_file_MCI2 = "control_features_void_negative.txt"
