...
desktop_path1 = joinpath(homedir(), "Desktop", "neurocon", "patient")
merged_data1 = merge_mat_files(desktop_path1)
println(size(merged_data1)) 

desktop_path2 = joinpath(homedir(), "Desktop", "neurocon", "control")
...
#println(join(output, ' '))
#println(size(output))
neurocon_paitents_void_features_qua_positive,neurocon_paitents_cycle_features_tri_positive,neurocon_paitents_void_features_qua_negative,neurocon_paitents_cycle_features_tri_negative = extract_features(merged_data1, T)
neurocon_control_void_features_qua_positive,neurocon_control_cycle_features_tri_positive,neurocon_control_void_features_qua_negative,neurocon_control_cycle_features_tri_negative = extract_features(merged_data2, T)
...
output_file_AD1 = "neurocon_paitents_void_features_qua_positive.txt"
writedlm(output_file_AD1, neurocon_paitents_void_features_qua_positive, '\t')  # 使用制表符分隔

output_file_AD2 = "neurocon_paitents_cycle_features_tri_positive.txt"
writedlm(output_file_AD2, neurocon_paitents_cycle_features_tri_positive, '\t')  # 使用制表符分隔

output_file_AD3 = "neurocon_paitents_void_features_qua_negative.txt"
writedlm(output_file_AD3, neurocon_paitents_void_features_qua_negative, '\t')  # 使用制表符分隔

output_file_AD4 = "neurocon_paitents_cycle_features_tri_negative.txt"
writedlm(output_file_AD4, neurocon_paitents_cycle_features_tri_negative, '\t')  # 使用制表符分隔

output_file_CN1 = "neurocon_control_void_features_qua_positive.txt"
writedlm(output_file_CN1, neurocon_control_void_features_qua_positive, '\t')  # 使用制表符分隔

output_file_CN2 = "neurocon_control_cycle_features_tri_positive.txt"
writedlm(output_file_CN2, neurocon_control_cycle_features_tri_positive, '\t')  # 使用制表符分隔

output_file_CN3 = "neurocon_control_void_features_qua_negative.txt"
writedlm(output_file_CN3, neurocon_control_void_features_qua_negative, '\t')  # 使用制表符分隔

output_file_CN4 = "neurocon_control_cycle_features_tri_negative.txt"
writedlm(output_file_CN4, neurocon_control_cycle_features_tri_negative, '\t')  # 使用制表符分隔
