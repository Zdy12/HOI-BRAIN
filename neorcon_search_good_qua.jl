...
#println(join(output, ' '))
#println(size(output))
neurocon_paitents_features_tri_positive,neurocon_paitents_features_qua_positive,neurocon_paitents_features_tri_negative,neurocon_paitents_features_qua_negative = extract_features(merged_data1, T)
println("=======================AD is ok")
neurocon_control_features_tri_positive,neurocon_control_features_qua_positive,neurocon_control_features_tri_negative,neurocon_control_features_qua_negative = extract_features(merged_data2, T)
println("=======================")
...
output_file_ad3 = "neurocon_paitents_features_tri_positive.txt"
writedlm(output_file_ad3, neurocon_paitents_features_tri_positive, '\t')  # 使用制表符分隔

output_file_ad4 = "neurocon_paitents_features_qua_positive.txt"
writedlm(output_file_ad4, neurocon_paitents_features_qua_positive, '\t')  # 使用制表符分隔

output_file_ad5 = "neurocon_paitents_features_tri_negative.txt"
writedlm(output_file_ad5, neurocon_paitents_features_tri_negative, '\t')  # 使用制表符分隔

output_file_ad6 = "neurocon_paitents_features_qua_negative.txt"
writedlm(output_file_ad6, neurocon_paitents_features_qua_negative, '\t')  # 使用制表符分隔

# 保存 features_CN

output_file_CN3 = "neurocon_control_features_tri_positive.txt"
writedlm(output_file_CN3, neurocon_control_features_tri_positive, '\t')  # 使用制表符分隔

output_file_CN4 = "neurocon_control_features_qua_positive.txt"
writedlm(output_file_CN4, neurocon_control_features_qua_positive, '\t')  # 使用制表符分隔

output_file_CN5 = "neurocon_control_features_tri_negative.txt"
writedlm(output_file_CN5, neurocon_control_features_tri_negative, '\t')  # 使用制表符分隔

output_file_CN6 = "neurocon_control_features_qua_negative.txt"
writedlm(output_file_CN6, neurocon_control_features_qua_negative, '\t')  # 使用制表符分隔
