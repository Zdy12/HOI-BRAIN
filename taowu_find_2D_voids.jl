...
Random.seed!(42)
# Path handling
desktop_path1 = joinpath(homedir(), "Desktop", "taowu", "patient")
merged_data1 = merge_mat_files(desktop_path1)
println(size(merged_data1)) 

desktop_path2 = joinpath(homedir(), "Desktop", "taowu", "control")
...
#println(join(output, ' '))
#println(size(output))
taowu_paitents_void_features_qua_positive,taowu_paitents_cycle_features_tri_positive,taowu_paitents_void_features_qua_negative,taowu_paitents_cycle_features_tri_negative = extract_features(merged_data1, T)
taowu_control_void_features_qua_positive,taowu_control_cycle_features_tri_positive,taowu_control_void_features_qua_negative,taowu_control_cycle_features_tri_negative = extract_features(merged_data2, T)
...
output_file_AD1 = "taowu_paitents_void_features_qua_positive.txt"
writedlm(output_file_AD1, taowu_paitents_void_features_qua_positive, '\t')  # 使用制表符分隔

output_file_AD2 = "taowu_paitents_cycle_features_tri_positive.txt"
writedlm(output_file_AD2, taowu_paitents_cycle_features_tri_positive, '\t')  # 使用制表符分隔

output_file_AD3 = "taowu_paitents_void_features_qua_negative.txt"
writedlm(output_file_AD3, taowu_paitents_void_features_qua_negative, '\t')  # 使用制表符分隔

output_file_AD4 = "taowu_paitents_cycle_features_tri_negative.txt"
writedlm(output_file_AD4, taowu_paitents_cycle_features_tri_negative, '\t')  # 使用制表符分隔

output_file_CN1 = "taowu_control_void_features_qua_positive.txt"
writedlm(output_file_CN1, taowu_control_void_features_qua_positive, '\t')  # 使用制表符分隔

output_file_CN2 = "taowu_control_cycle_features_tri_positive.txt"
writedlm(output_file_CN2, taowu_control_cycle_features_tri_positive, '\t')  # 使用制表符分隔

output_file_CN3 = "taowu_control_void_features_qua_negative.txt"
writedlm(output_file_CN3, taowu_control_void_features_qua_negative, '\t')  # 使用制表符分隔

output_file_CN4 = "taowu_control_cycle_features_tri_negative.txt"
writedlm(output_file_CN4, taowu_control_cycle_features_tri_negative, '\t')  # 使用制表符分隔
