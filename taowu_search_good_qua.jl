...
#println(join(output, ' '))
#println(size(output))
taowu_paitents_features_tri_positive,taowu_paitents_features_qua_positive,taowu_paitents_features_tri_negative,taowu_paitents_features_qua_negative = extract_features(merged_data1, T)
println("=======================AD is ok")
taowu_control_features_tri_positive,taowu_control_features_qua_positive,taowu_control_features_tri_negative,taowu_control_features_qua_negative = extract_features(merged_data2, T)
println("=======================")
...
output_file_ad3 = "taowu_paitents_features_tri_positive.txt"
writedlm(output_file_ad3, taowu_paitents_features_tri_positive, '\t')  # 使用制表符分隔

output_file_ad4 = "taowu_paitents_features_qua_positive.txt"
writedlm(output_file_ad4, taowu_paitents_features_qua_positive, '\t')  # 使用制表符分隔

output_file_ad5 = "taowu_paitents_features_tri_negative.txt"
writedlm(output_file_ad5, taowu_paitents_features_tri_negative, '\t')  # 使用制表符分隔

output_file_ad6 = "taowu_paitents_features_qua_negative.txt"
writedlm(output_file_ad6, taowu_paitents_features_qua_negative, '\t')  # 使用制表符分隔

# 保存 features_CN

output_file_CN3 = "taowu_control_features_tri_positive.txt"
writedlm(output_file_CN3, taowu_control_features_tri_positive, '\t')  # 使用制表符分隔

output_file_CN4 = "taowu_control_features_qua_positive.txt"
writedlm(output_file_CN4, taowu_control_features_qua_positive, '\t')  # 使用制表符分隔

output_file_CN5 = "taowu_control_features_tri_negative.txt"
writedlm(output_file_CN5, taowu_control_features_tri_negative, '\t')  # 使用制表符分隔

output_file_CN6 = "taowu_control_features_qua_negative.txt"
writedlm(output_file_CN6, taowu_control_features_qua_negative, '\t')  # 使用制表符分隔
